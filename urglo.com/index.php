...
<html lang="en" id="home"  >
  ...
  <head>
    ...
    <title>Urglo: Es momento del siguiente nivel ¡Juega con los mejores!</title>

    <meta name="description" content="En Urglo trabajamos con los mejores jugadores de toda la región quienes están dispuestos a jugar partidas en tu nombre, mejorando así rápidamente tus métricas.">


    <link rel="shortcut icon" href="/favicon.png">

    <meta property="og:title" content="Urglo: Es momento del siguiente nivel ¡Juega con los mejores!">
    <meta property="og:url" content="https://urglo.com/">
    <meta property="og:description" content="En Urglo trabajamos con los mejores jugadores de toda la región quienes están dispuestos a jugar partidas en tu nombre, mejorando así rápidamente tus métricas.">
    ...
    <section id="intro">
      <div class="container-lg">
        ...
        <h1 class="titleport" STYLE="">
          <span style="color:#CBE1F3;">Urglo:</span> Es momento del siguiente nivel
        </h1>
        ...
        <option data-default='true' disabled selected>Elige juego...</option>
            <option value="eloboosting">League Of Legends</option>
            <option value="csgoboost">Counter Strike GO</option>
            <option value="csgoboost">Dota 2</option>
            <option value="csgoboost">World of Warcraft</option>
            <option value="csgoboost">Overwatch</option>     
            <option value="csgoboost">Heroes Of The Storm</option>       
            </select>
        </span>
  ...
  <section class="main setup" id="seller-setup" style="padding-top: 0px !important;">
    <div class="content">
      <header class="icon">
        ...
        <p>¡Juega con los mejores, se de los mejores! Nosotros te ayudamos a avanzar al siguiente escalón, tú parte del trabajo es demostrar que eres uno de ellos.</p>
      </header>
      <aside>
        ...
        <p>Hemos desarrollando una plataforma a medida, dentro de esta podrás realizar seguimiento a los avances de tu cuenta, procesar pagos con método de pago locales y más.</p>
      </aside>
      <ul class="features">
        <li class="setup">
          <h3>¿Cómo lo hacemos?</h3>
          <p>
En Urglo trabajamos con los mejores jugadores de toda la región quienes están dispuestos a jugar partidas en tu nombre, mejorando así rápidamente tus métricas, nivel o liga dentro del juego.</p>
        <li class="custom">
          <h3>Potente metodología de aprendiza</h3>
          <p>Una de las mejores maneras de adquirir nuevas habilidades en juego es apreciar en directo cómo un jugador experimentado resuelve con éxito las mismas situaciones a las que te enfrentas día a día.</p>
        </li>
        <li class="payouts">
          <h3>Chat en vivo</h3>
          <p>Buscando maximizar el proceso de aprendizaje y mantenerte comunicado con nuestro jugador hemos integrado un chat para que una vez terminada la partida puedas enviar tus consultas.
</p>
        </li>
      </ul>
    </div>
