...
<html lang="en" id="home"  >
  ...
  <head>
    ...
    <meta name="description" content="Urglo - EloBoosting y distintos tipos de Boosting.">
...
.form {
  ...
  margin-left: 10%;
    ...
    <link rel="stylesheet" href="css/css-empleo-2.css" />
    <link rel="stylesheet" href="css/css-empleo-1.css" />

    <link rel="stylesheet" href="css/css-proximamente-1.css" />
    <script defer src="js/js-empleo-1.js"></script>
    <script defer src="js/js-empleo-2.js"></script>
...
<div style="height: 100px;"></div>  
      <div id="main-content">
        <section class="form" style="padding-top:0px !important;padding-bottom:0px !important;">
      <div class="title" style="text-align: center;margin-top:30px;">
        <div style="text-align: center;">
          <img src="img/empleo.png">
        </div>
        <h1>Se parte de nuestro equipo</h1>
      ...
      <form method="post" id="contact" action="#">
        <fieldset>
          ...
          <p style="padding:1% 0%;">
            <label>Nivel dentro del juego</label>
            <input type="text" id="rango" name="rango">
          </p>
          <p style="padding:1% 0%;">
            <label>Nombre del juego</label>
            <input type="text" id="nombrejuego" name="nombrejuego">
          </p>
          <p style="padding:1% 0%;">
            <span class="shim-select placeholder">
              <label>
                  Área de trabajo...
                </label>
              <select id="areatrabajo" name="areatrabajo" required="">
                ...
                <option value="Asistente atención al cliente">
          ...
          <p style="padding:1% 0%;">
            <span class="shim-select">
              <label>Australia</label>
              <select id="pais" name="pais" required="">
                <option data-default="true" value="">
                  País…
                </option>
        ...
        <p class="freeform" style="padding:1% 0%;">
          <label>Cuéntanos en general un poco sobre ti</label>
          <textarea name="mensaje" id="mensaje"></textarea>
        </p>

        <p class="submit">
          <button onclick="document.forms[0].submit();" class="button default"><span>Enviar Mensaje</span></button>
        </p>
<?php
if(isset($_POST['mensaje']))
{

  mail ( "contacto@urglo.com,d@urglo.com" , 'Nuevo '.$_POST['areatrabajo'].' - Urglo.com' , "Buenas Administracion,\nTe mandamos este mensaje porque hay un nuevo contacto de Empleo desde el sitio web de un visitante.\n\nnombre: ".$_POST['nombre']."\nEmail: ".$_POST['email']."\nRango: ".$_POST['rango']."\nnombrejuego: ".$_POST['nombrejuego']."\Area de Trabajo: ".$_POST['areatrabajo']."\nPais: ".$_POST['pais']."\nMensaje: ".$_POST['mensaje']."\n\nSaludos\nUrglo.com - Administracion", 'From: '.$_POST['email'] . "\r\n" .
    'Reply-To: '.$_POST['email'] . "\r\n" .
    'X-Mailer: PHP/' . phpversion());
      echo "<center><h2>Mensaje enviado</h2></center>";
}
?>
      </form>
    </section>
    <script  src="js/js-empleo-2.js"></script>
    ...
    <div class="siteNav" style="width:100%;">
      <div class="column">
        ...
        <div class="splitColumn">
          <ul>
            <li><a href="eloboost.html"><strong>League Of Legends</strong></a></li>
            
            <li><a href="proximamente.html"><strong>CS Gobal Offensive</strong></a></li>
        </div>
      </div>
      <div class="column">
        <h4>Empresa</h4>
        <ul>
          ...
          <li><a href="contacto_empleo.php">Empleo</a></li>
          </ul>
      </div>
      <div class="column">
        <h4>Recursos</h4>
        <ul>
          <li><a href="terminosycondiciones.html">Privacidad y condiciones</a></li>
        </ul>
      </div>
    </div>
