  ...
  <article>
    ...
    <section class='status'>
      <!--<div id='available' style='display:none'>
        <header>
          <h2>Stripe is available in <span class='country'></span>.</h2>
          <p>Sign up and start accepting payments today.</p>
        </header>

        <p>
          Stripe is a set of unified APIs and tools that<br> instantly enable businesses to accept and<br> manage online&nbsp;payments.
        </p>
        <p class="button-group">
          <a href="https://dashboard.stripe.com/register" class="button default"><span>Get started with Stripe</span></a>
          <a href="https://stripe.com/features" class="button secondary"><span>Get notified about your country</span></a>
        </p>
      </div>-->
