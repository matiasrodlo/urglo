$(document).on("ready", function()
{
    ...
    $("#actp").on("click", function(){
        var precio_elo = $("input[name='precio_elo']").val();
        var pedido = $("input[name='pedido']").val();
        if(precio_elo == '')
        {
            alert('Ingresa alguna ganancia para el elobooster');
        }
        else
        {
            $.ajax
            ({
                ...
                type:'POST',
                url:'activar_pedido',
                data: {pedido: pedido, precio_elo: precio_elo},
    ...
    $("#mandaremail").on("click", function(){
            ...
            ({
                async:true,
                type:'POST',
                url:'http://urglo.com/eloboost/miembros/mandaremaileloboosters',
                data: {},
                beforeSend: function(){$("#resultado").html('<div id="alert-msg">Mandando...</div>');},
                timeout: 50000,
                success: function(data){$('#resultado').html('<div id="alert-msg">Mandado</div>');},
            });
    });
    ...
    $("#bclick").on("click", function(){
        ...
        if(user == '')
        {
            alert('Introduce algun usuario para buscar..');
        }
        else
        {
            $.ajax
