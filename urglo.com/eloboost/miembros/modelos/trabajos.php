...
Primero que todo, debo comentarte que luego que contratas uno de nuestros servicios, tendrás que esperar a que tu pago sea validado. Una vez este sea validado comenzaremos a trabajar en tu cuenta dentro de las primeras 24 horas posteriores a tu compra.</br>
...
* Recibirás este mensaje al realizar un pedido, incluso si este aún no ha sido pagado. La activación de su pedido puede tardar según el medio de pago elegido, puede comprobar el estado de su pago ingresando a su pedido.';
				$this->codigosql = "INSERT INTO mensajes VALUES (null, 'Nueva Orden Entrenadores - Eloboost Latinoamerica', '$contenido', '$id_usuario', '1', '$fecha', '$hora', '0')";
				$this->consulta_simple();
				...
				if($this->consulta)
				{
					...
					$this->codigosql = "INSERT INTO mensajes VALUES (null, 'Tienes una nueva Orden Entrenadores - Eloboost Latinoamerica', '$contenido', '$coach', '2', '$fecha', '$hora', '0')";
					$this->consulta_simple();
...
* Recibirás este mensaje al realizar un pedido, incluso si este aún no ha sido pagado. La activación de su pedido puede tardar según el medio de pago elegido, puede comprobar el estado de su pago ingresando a su pedido.';
				$this->codigosql = "INSERT INTO mensajes VALUES (null, 'Nueva Orden Entrenadores - Eloboost Latinoamerica', '$contenido', '$id_usuario', '2', '$fecha', '$hora', '0')";
				$this->consulta_simple();
				...
				if($this->consulta)
				{
					...
					Tienes una nueva orden de @'.$cliente[0]['usuario'].', contáctate con el para coordinar el servicio. Recuerda ser cordial y satisfacer al cliente. Cualquier infracción a las normas será penalizada. 
					¡Que tengas un buen día entrenador! ';
					$this->codigosql = "INSERT INTO mensajes VALUES (null, 'Tienes una nueva Orden Entrenadores - Eloboost Latinoamerica', '$contenido', '$coach', '1', '$fecha', '$hora', '0')";
					$this->consulta_simple();
