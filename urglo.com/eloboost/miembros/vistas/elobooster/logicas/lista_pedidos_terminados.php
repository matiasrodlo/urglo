<?php
$html = file_get_contents('vistas/elobooster/lista_pedidos_terminados.html');
...
else
{
	...
	for($i=0;$i<count($mis_ordenes);$i++)
	{
		...
		elseif($orden[0]['id_elobooster'] == $_SESSION['id_usuario'])
		{
			if($orden[0]['estado'] == '4')
			{
			...
			if($tipo == '1')
			{
				...
				<tr style="background-color:#fff;color:#000;">
					...
					<td width="67px" style="border:1px solid #dddddd;">
						<a href="http://urglo.com/eloboost/miembros/pedidos_terminados/'.$orden[0]['id_pedido'].'">
