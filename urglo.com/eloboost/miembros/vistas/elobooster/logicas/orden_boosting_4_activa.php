<?php
	$html = file_get_contents('vistas/elobooster/orden_boosting_4_activa.html');
	...
	if($orden[0]['id_level_pasado'] == '5')
	{
		$level_inicio = '1';
	}
	elseif($orden[0]['id_level_pasado'] == '4')
	{
		$level_inicio = '2';
	}
	elseif($orden[0]['id_level_pasado'] == '3')
	{
		$level_inicio = '3';
	}
	elseif($orden[0]['id_level_pasado'] == '2')
	{
		$level_inicio = '4';
	}
	elseif($orden[0]['id_level_pasado'] == '1')
	{
		$level_inicio = '5';
	}
	elseif($orden[0]['id_level_pasado'] == '6')
	{
		$level_inicio = '6';
	}
	...
	$started = level($orden[0]['id_level_pasado'], '0');
