...
$llave= md5("L2GR6wyO2EjnTg01iXpp13Q6h3~571429~$verificacion~$amount~COP")
?>
...
&emsp; <input name="accountId" type="hidden" value="575072">
&emsp; <input name="description" type="hidden" value="Eloboost">
...
&emsp; <input name="currency" type="hidden" value="COP">
&emsp; <input name="lng" type="hidden" value="es">
&emsp; <input name="sourceUrl" id="urlOrigen" value="http://urglo.com/eloboost/miembros/" type="hidden">
