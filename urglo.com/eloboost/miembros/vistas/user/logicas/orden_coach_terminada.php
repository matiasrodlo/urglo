<?php
	$id_trabajo = $url[2];
	$html = file_get_contents('vistas/user/orden_coach_terminada.html');
		...
		$html = str_replace('{calificar}', '
			<div>
				<div class="ratingBig" style="margin-bottom:10px;">
					<img src="http://urglo.com/eloboost/miembros/images/rating-stars.png" class="rat'.$calificacion[0]['calificacion'].'" align="middle">
				</div>
				<div id="puntuacion" style="color:#555;font-size:14px;font-family:Helvetica, sans-serif;">
