<?php
			...
			if($tipo == '1')
			{
				...
				<tr>
                    ...
                    <td class="center" style="vertical-align:middle;width:4%;">
                        <a href="http://urglo.com/eloboost/miembros/boosting/mis_ordenes/'.$orden[0]['id_pedido'].'">
	...
	for($i=0;$i<count($mis_ordenes);$i++)
	{
		if($mis_ordenes[$i]['estado'] == '1' or $mis_ordenes[$i]['estado'] == '2' or $mis_ordenes[$i]['estado'] == '4')
		{
			...
			$lista_mis_ordenes.='
			<li>
                <a href="http://urglo.com/eloboost/miembros/coachs/mis_ordenes/'.$mis_ordenes[$i]['id_trabajo_coach'].'" style="text-decoration:none">
                    <img src="http://urglo.com/eloboost/miembros/images/user/'.$coach_personal[0]['img_perfil'].'">
                    <div class="uinfo">
	...
	else
	{
		for($i=0;$i<count($ultimas_calificaciones);$i++)
		{
			...
			$lista_ultimas_calificaciones.='
			<li>
                <a href="http://urglo.com/eloboost/miembros/coachs/mis_ordenes/'.$ultimas_calificaciones[$i]['id_trabajo'].'" style="text-decoration:none">
                    <img src="http://urglo.com/eloboost/miembros/images/user/'.$coach_personal[0]['img_perfil'].'">
                    <div class="uinfo">
                        <h5>Calificacion al coach <b>'.$coach[0]['usuario'].'</b></h5>
                        <span>Calificacion:</span>
			            <div class="ratingSmall" style="margin:-2px 0;">
							<img src="http://urglo.com/eloboost/miembros/images/rating-stars-small.png" align="middle" class="rat'.$ultimas_calificaciones[$i]['calificacion'].'" style="width:98px;height:120px;">
						</div>
                    </div>
                </a>
            </li>
	...
	else
	{
		for($i=0;$i<count($top3);$i++)
		{
			...
			$lista_top.='<li>
		                <a href="http://urglo.com/eloboost/miembros/coachs/'.$datos_usuario[0]['usuario'].'" style="text-decoration:none">
		                    <img src="http://urglo.com/eloboost/miembros/images/user/'.$datos_user_per[0]['img_perfil'].'">
		                    <div class="uinfo">
		                        <h5><b>'.$datos_usuario[0]['usuario'].'</b></h5>
					            <div class="ratingSmall" style="margin:-2px 0;">
								<img src="http://urglo.com/eloboost/miembros/images/rating-stars-small.png" align="middle" class="rat'.$rating.'" style="width:98px;height:120px;">
								</div>
