...
{
	$html = file_get_contents('vistas/desconectado/contacto.html');
...
else
{
	...
	$html = str_replace('{mensaje}', '<div id="resultado" class="alert alert-info alert-block">Gracias por contactarte con nosotros!</div>', $html);
