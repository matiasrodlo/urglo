<?php
	$html = file_get_contents('vistas/desconectado/coachs.html');
	...
	for($i=0;$i<count($lista_coachs);$i++)
	{
		...
		else
		{
			...
			$lista_coachs_all.='
				<a id="cphBody_lvData_hlCoach_'.$i.'" class="coach-details" href="http://urglo.com/eloboost/miembros/coachs/'.$nombre_usuario.'">
					<div class="profile-img">
						<img src="http://urglo.com/eloboost/miembros/images/user/'.$personal_coach[0]['img_perfil'].'" style="width:240px;height:210px">
					</div>
					...
					<div class="w-league">
						<img id="cphBody_lvData_imgLeague_'.$i.'" src="http://urglo.com/eloboost/miembros/images/Game/'.$img.'.png" style="width:100%;">
					</div>
					<div class="w-title">
						<center>
							...
							<div class="ratingSmall">
								<img id="cphBody_lvData_imgRating_'.$i.'" src="http://urglo.com/eloboost/miembros/images/rating-stars-small.png" align="middle" class="rat'.$rating.'">
							</div>
						</center>
					</div>
