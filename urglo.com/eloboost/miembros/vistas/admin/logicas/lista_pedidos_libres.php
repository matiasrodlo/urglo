<?php
$html = file_get_contents('vistas/admin/lista_pedidos_libres.html');
...
if($mis_ordenes == false)
{
	$html = str_replace('{lista_ordenes_boosting}', '
		<tr style="background-color:#fff;color:#000;">
			<td colspan="6" style="border:0px;">No hay ningún pedido libre.</td>
		</tr>', $html);
}
else
{
			...
			if($tipo == '1')
			{
				...
				<tr style="background-color:#fff;color:#000;">
					...
					<td width="67px" style="border:1px solid #dddddd;">
						<a href="http://urglo.com/eloboost/miembros/elobooster/pedidos_libres/'.$orden[0]['id_pedido'].'">
