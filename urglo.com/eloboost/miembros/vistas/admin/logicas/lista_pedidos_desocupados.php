<?php
$html = file_get_contents('vistas/admin/lista_pedidos_desocupados.html');
			...
			if($tipo == '1')
			{
				...
				<tr style="background-color:#fff;color:#000;">
					...
					<td width="67px" style="border:1px solid #dddddd;">
						<a href="http://urglo.com/eloboost/miembros/elobooster/pedidos_desocupados/'.$orden[0]['id_pedido'].'">
