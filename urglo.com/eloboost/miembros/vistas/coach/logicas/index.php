<?php
			...
			$lista_ultimos_trabajos.='
				<tr>
		            ...
		            <td class="center" style="vertical-align:middle;">
		                <a href="http://urglo.com/eloboost/miembros/trabajos/'.$ultimos_trabajos[$i]['id_trabajo_coach'].'">
	...
	else
	{
		...
		{	
			...
			$lista_ultimas_calificaciones.='
			<li>
				<a href="http://urglo.com/eloboost/miembros/trabajos/'.$mis_ultimas_calificaciones[$i]['id_trabajo'].'" style="text-decoration:none">
	...
	else
	{
		for($i=0;$i<count($mis_ultimas_ganancias);$i++)
		{
			...
			<li>
				<a href="http://urglo.com/eloboost/miembros/trabajos/'.$mis_ultimas_ganancias[$i]['id_trabajo_coach'].'" style="text-decoration:none">
					<img src="http://urglo.com/eloboost/miembros/images/user/'.$user_personal[0]['img_perfil'].'">
					<div class="uinfo" style="display:inline-block;margin-left:10px;vertical-align:middle;">
