<?php
	$html = file_get_contents('vistas/coach/lista_trabajos_cancelados.html');
	...
	else
	{
		for($i=0;$i<count($lista_pedidos);$i++)
		{
			...
			<tr style="background-color:#fff;color:#000;">
				...
				<td style="border:1px solid #dddddd;"><a href="http://urglo.com/eloboost/miembros/trabajos/'.$lista_pedidos[$i]['id_trabajo_coach'].'"><div class="btn_details">Ver Detalles</div></a></td>
			</tr>';
		}
