...
<div style="height: 100px; background-color: #FFFFFF !important;"></div>
  ...
  <article class="laptop">
    ...
    <form id="formpiola" method="post" action="proximamente_enviado"> 
      <div id='signup-form'>
        <header>
          <h2>Inscríbete para recibir notificaciones.</h2>
          <p>Te avisamos cuando nuestros servicios estén disponibles para tu juego favorito.</p>
        </header>
    <input name="email" placeholder="your@email.com" tabindex="1" type="email" value="" style="min-width:100% !important;height: 45px;">

            <select class="selectloco" name="producto" id="producto" type="email" spellcheck="false" id="inline_input" placeholder="Email address" class="input_email input_inline small_right_margin" style="height:  45px; font-size:  14px;min-width:100%;color:#C6C9CB;margin: 5% 0%;">
        <option data-default='true' disabled selected>Elige juego...</option>
            <option value="proximamente">Counter Strike GO</option>
            <option value="proximamente">Dota 2</option>
            <option value="proximamente">World of Warcraft</option>
            <option value="proximamente">Overwatch</option>     
            <option value="proximamente">Heroes Of The Storm</option>       
            </select>
 <center> <button type="submit" onclick="document.getElementById("formpiola").submit();" class="button default"><span>Notifícame</span></button></center>
</form>
<div id='success' >
  Thanks! We'll be in touch.
</div>
<p  class=''  style=" bottom: -10px; position: relative;    bottom: 44px;
    color: #a0a9ae;
    font-weight: 300;
    font-size: 1.4em; margin-top: 60px;">
 Actualmente estamos trabajando para ofrecer nuestros servicios para la mayor cantidad de juegos posibles y lógicamente para tu favorito.
    ...
    <section class='status movil tablet' style="width: 100%;display: block; float:none;padding: 5%;height: 445px;padding-top: 0px !important; ">
