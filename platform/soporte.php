...
<html lang="en" id="home"  >
  ...
  <head>
    ...
    <meta name="description" content="Urglo - coaching y entrenamiento personalizado.">
    ...
    <meta property="og:description" content="Urglo es el sistema definitivo para Coaching y Entrenamiento de Juegos.">
        ...
        <div class="popup">
          <div class="popupContainer">
            ...
            <div class="mobileProducts">
              ...
              <a class="mobileSignIn" data-adroll-segment="submit_two" href="app/" data-analytics-source="mobile_nav" data-analytics-action="sign_in">
                Área de Miembros
            </a>
          </div>
        </div>
    ...
    <div class="siteNav" style="width:100%;">
      <div class="column">
        ...
        <div class="splitColumn">
          <ul>
            <li><a href="coaching"><strong>Coaching</strong></a></li>
            
            <li><a href="proximamente"><strong>CS Gobal Offensive</strong></a></li>
        </div>
      </div>
      <div class="column">
        <h4>Empresa</h4>
