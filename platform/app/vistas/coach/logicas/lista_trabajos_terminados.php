<?php
	$html = file_get_contents(__DIR__ . '/../lista_trabajos_terminados.html');
	...
	$lista_pedidos = $trabajos->lista_trabajos('4', $id_usuario);
	...
	if(count($lista_pedidos) == 0)
	{
		$html = str_replace('{lista_ordenes_libres}', '
			<tr style="background-color:#fff;color:#000;">
				<td colspan="5" style="border:0px;">No hay ningun orden contratada.</td>
			</tr>
			', $html);
	}
	else
