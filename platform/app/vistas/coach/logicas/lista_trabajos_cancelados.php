<?php
	$html = file_get_contents(__DIR__ . '/../lista_trabajos_cancelados.html');
	...
	$lista_pedidos = $trabajos->lista_trabajos('3', $id_usuario);
	...
	{
		$html = str_replace('{lista_ordenes_libres}', '<tr style="background-color:#fff;color:#000;">
				<td colspan="5" style="border:0px;">No hay ningun orden cancelada.</td>
			</tr>', $html);
	}
	else
	{
		for($i=0;$i<count($lista_pedidos);$i++)
		{
			...
			<tr style="background-color:#fff;color:#000;">
				...
				<td style="border:1px solid #dddddd;"><a href="'.RUTA_INDEX.'trabajos/'.$lista_pedidos[$i]['id_trabajo_coach'].'"><div class="btn_details">Ver Detalles</div></a></td>
			</tr>';
		}
