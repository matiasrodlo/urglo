<?php
$html = file_get_contents(__DIR__ . '/../lista_pedidos_cancelados.html');
...
else
{
			...
			if($tipo == '1')
			{
				...
				<tr style="background-color:#fff;color:#000;">
					...
					<td width="67px" style="border:1px solid #dddddd;">
						<a href="'.RUTA_INDEX.'coach/pedidos_cancelados/'.$orden[0]['id_pedido'].'">
	...
	if($lista_ordenes_coaching == '' || count($mis_ordenes) == 0)
	{
		$html = str_replace('{lista_ordenes_coaching}', '
		<tr style="background-color:#fff;color:#000;">
			<td colspan="6" style="border:0px;">No hay ningún pedido cancelado.</td>
