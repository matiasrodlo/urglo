...
class Mensajes extends Conexion {
	...
	{
		$this->codigosql = "SELECT * FROM mensajes WHERE id_remitente='$id_usuario' LIMIT 0,5";
		$this->obtener_resultados();
		if($this->num_resultados > 0)
		{
			return $this->resultado;
	...
	{
		$this->codigosql = "SELECT * FROM mensajes WHERE id_mensaje='$id_mensaje' and id_receptor='$id_receptor' LIMIT 0,1";
		$this->obtener_resultados();
		if($this->num_resultados > 0)
		{
			return $this->resultado;
