								...
								if(isset($_POST['precio_team']))
								{
									...
									if(isset($_POST['roles']))
									{
										...
										if(isset($_POST['idiomas']))
										{
											...
											$resultado = $usuarios->editar_miperfil_coach($id_usuario, $servidor, $contenido, $level, $division, $champion1, $champion2, $champion3, $champion4, $roles, $idiomas, $precio_personal, $precio_team);
											echo $resultado;
										}
										else
										{
