<?php
	$html = file_get_contents('vistas/coacher/index.html');
	...
	///////////////////////// MIS ULTIMOS TRABAJOS coachingS //////////////////////////////
	$id_coacher = $_SESSION['id_usuario'];
	$mis_ordenes = $pedidos->mis_ultimas_ordenes_coach($id_coacher);
	$lista_ordenes_coaching = '';
	if($mis_ordenes == false)
	{
		$html = str_replace('{lista_ultimas_coaching}', '<tr style="background-color:#fff;color:#000;">
	...
	else
	{
		...
		for($i=0;$i<count($mis_ordenes);$i++)
		{
			...
			elseif($orden[0]['estado'] == '2')
			{
				...
				$url = 'http://urglo.com/miembros/pedidos_activos/'.$orden[0]['id_pedido'].'';
			}
			...
			elseif($orden[0]['estado'] == '4')
			{
                ...
                $url = 'http://urglo.com/miembros/pedidos_terminados/'.$orden[0]['id_pedido'].'';
			}
			if($tipo == '1')
			{
	...
	$mis_ultimas_ordenes = $pedidos->mis_ultimas_ordenes_coach($id_coacher);
			...
			{	
				$lista_ultimas_ganancias.='
					<li style="margin-left:0px;">
						<a href="http://urglo.com/miembros/pedidos_terminados/'.$orden[0]['id_pedido'].'" style="text-decoration:none">
