<?php
	...
	for($i=0;$i<count($roles);$i++)
	{
		...
		$roles_coach.='<img src="http://urglo.com/miembros/images/Roles/'.$rol[0]['img'].'" width="30" align="center" title="'.$rol[0]['nombre'].'">';
	}
	if($roles == false)
	{
	...
	for($i=0;$i<count($idiomas);$i++)
	{
		...
		$idiomas_coach.='<img src="http://urglo.com/miembros/images/Languages/'.$idioma[0]['bandera'].'" width="30" align="center" title="'.$idioma[0]['idioma'].'">'; 
	}
	if($idioma == false)
	{
		...
		for($i=0;$i<count($opiniones);$i++)
		{
			...
			<div class="pad10" style="background:#eee; margin-top:10px;">
                <div class="ratingSmall">
                    <img class="rat'.$opiniones[$i]['calificacion'].'" src="http://urglo.com/miembros/images/rating-stars-small.png" align="middle">
                </div>
