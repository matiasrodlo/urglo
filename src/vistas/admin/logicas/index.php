...
////////////////////// LISTA ULTIMOS PEDIDOS TERMINADOS coacher //////////////////////
				...
				<tr>
					<td class="center" style="vertical-align: middle;">
						...
						<p class="price-ord" style="margin-top:15px;">
							<span class="subtitle">Ganancia coacher : </span> '.$orden[0]['precio_elo'].' <span class="subtitle">USD</span><br/>
	                ...
	                <td class="center" style="vertical-align:middle;width:4%;">
	                    <a href="http://urglo.com/miembros/coacher/pedidos_terminados/'.$orden[0]['id_pedido'].'">
	...
	for($i=0;$i<count($ultimos_trabajos);$i++)
	{
		...
		$lista_ultimos_trabajos.='
			<tr>
		        ...
		        <td class="center" style="vertical-align:middle;">
		            <a href="http://urglo.com/miembros/coachs/trabajos_terminados/'.$ultimos_trabajos[$i]['id_trabajo_coach'].'">
		                <div class="btn_details">Detalles</div>
		            </a>
		        </td>
		    </tr>
...
else
{
	...
	for($i=0;$i<count($mis_ordenes);$i++)
	{
		...
		if($orden[0]['estado'] == '1')
		{
			$estado = '<h5 style="font-size:14px;font-weight: normal;line-height: normal;">Orden</h5>
                       <p class="subtitle" style="margin:0px;color:#a00">Orden no paga</p>';
			$url = 'http://urglo.com/miembros/coacher/pedidos_libres/'.$orden[0]['id_pedido'].'';
		}
		elseif($orden[0]['estado'] == '2')
		{
			$estado = '<h5 style="font-size:14px;font-weight: normal;line-height: normal;">Orden</h5>
                       <p class="subtitle" style="margin:0px;color:#aaab40">Orden en Proceso</p>';
			$url = 'http://urglo.com/miembros/coacher/pedidos_activos/'.$orden[0]['id_pedido'].'';
		}
		elseif($orden[0]['estado'] == '3')
		{
			$estado = '<h5 style="font-size:14px;font-weight: normal;line-height: normal;">Orden</h5>
                       <p class="subtitle" style="margin:0px;color:#a00">Orden cancelada</p>';
			$url = 'http://urglo.com/miembros/coacher/pedidos_cancelados/'.$orden[0]['id_pedido'].'';
		}
		elseif($orden[0]['estado'] == '4')
		{
			$estado = '<h5 style="font-size:14px;font-weight: normal;line-height: normal;">Orden</h5>
                       <p class="subtitle" style="margin:0px;color:#3E941C">Orden Terminada</p>';
			$url = 'http://urglo.com/miembros/coacher/pedidos_terminados/'.$orden[0]['id_pedido'].'';
		}
		elseif($orden[0]['estado'] == '5')
		{
			$estado = '<h5 style="font-size:14px;font-weight: normal;line-height: normal;">Orden</h5>
                       <p class="subtitle" style="margin:0px;color:#3E941C">Orden Terminada</p>';
			$url = 'http://urglo.com/miembros/coacher/pedidos_desocupados/'.$orden[0]['id_pedido'].'';
		}
		if($tipo == '1')
		{
			$level_current = level($orden[0]['id_level_current'], $orden[0]['id_division_current']);
...
else
{
	for($i=0;$i<count($ultimos_trabajos);$i++)
	{
		...
		if($ultimos_trabajos[$i]['estado'] == '1')
		{
			...
			$url = 'http://urglo.com/miembros/coachs/trabajos_libres/'.$ultimos_trabajos[$i]['id_trabajo_coach'].'';
		}
		elseif($ultimos_trabajos[$i]['estado'] == '2')
		{
			$estado = "Orden en Proceso";
			$url = 'http://urglo.com/miembros/coachs/trabajos_activos/'.$ultimos_trabajos[$i]['id_trabajo_coach'].'';
		}
		elseif($ultimos_trabajos[$i]['estado'] == '3')
		{
			$estado = "Orden Cancelada";
			$url = 'http://urglo.com/miembros/coachs/trabajos_cancelados/'.$ultimos_trabajos[$i]['id_trabajo_coach'].'';
		}
		elseif($ultimos_trabajos[$i]['estado'] == '4')
		{
			$estado = "Orden Terminada";
			$url = 'http://urglo.com/miembros/coachs/trabajos_terminados/'.$ultimos_trabajos[$i]['id_trabajo_coach'].'';
		}
...
else
{
	...
	{	
		...
		$lista_ultimas_calificaciones.='
		<li>
			<a href="http://urglo.com/miembros/coachs/trabajos_terminados/'.$mis_ultimas_calificaciones[$i]['id_trabajo'].'" style="text-decoration:none">
