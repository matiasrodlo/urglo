	...
	for($i=0;$i<count($mis_ordenes);$i++)
	{
		if($mis_ordenes[$i]['estado'] == '1' or $mis_ordenes[$i]['estado'] == '2' or $mis_ordenes[$i]['estado'] == '4')
		{
			...
			<tr style="background-color:#fff;color:#000;">
				...
				<td style="border:1px solid #dddddd;">
					<h4><a href="http://urglo.com/miembros/coachs/'.$datos_coach[0]['usuario'].'">'.$datos_coach[0]['usuario'].'</a></h4>
				...
				<td style="border:1px solid #dddddd;"><a href="http://urglo.com/miembros/coachs/mis_ordenes/'.$mis_ordenes[$i]['id_trabajo_coach'].'"><div class="btn_details">Ver Detalles</div></a></td>
			</tr>';
		}
		else
		{
