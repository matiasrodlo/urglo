...
if (isset($_SESSION['usuario'])) 
{
	...
	elseif($_SESSION['tipo'] == 'coacher')
	{
		...
		{
			case '':
				require_once('vistas/coacher/logicas/index.php');
			break;

			case 'perfil':
				require_once('vistas/coacher/logicas/editar_perfil.php');
			break;

			case 'editar_personal_accion':
				require_once('vistas/coacher/logicas/editar_personal_accion.php');
			break;

			case 'editar_password_accion':
				require_once('vistas/coacher/logicas/editar_pw_accion.php');
			break;
			...
			case 'pedidos_desocupados':
				if(isset($url[1]))
				{
					...
					{
						case '':
							require_once('vistas/coacher/logicas/lista_pedidos_desocupados.php');
						break;
						...
						case ''.$url[1].'':
							...
							if($resultado == '')
							{
								header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/pedidos_desocupados');
							}
							else
							{
								require_once('vistas/coacher/logicas/pedidos.php');
							}
						break;
					}
				}
			...
			case 'pedidos_activos':
				if(isset($url[1]))
				{
					...
					{
						case '':
							require_once('vistas/coacher/logicas/lista_pedidos_activos.php');
						break;
						...
						case ''.$url[1].'':
							...
							if($resultado[0]['id_coacher'] == $_SESSION['id_usuario'])
							{
								if($resultado == '')
								{
									header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/pedidos_activos');
								}
								else
								{
									require_once('vistas/coacher/logicas/pedidos.php');
			...
			case 'pedidos_terminados':
				if(isset($url[1]))
				{
					...
					{
						case '':
							require_once('vistas/coacher/logicas/lista_pedidos_terminados.php');
						break;
						...
						case ''.$url[1].'':
							...
							if($resultado[0]['id_coacher'] == $_SESSION['id_usuario'])
							{
								if($resultado == '')
								{
									header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/pedidos_terminados');
								}
								else
								{
									require_once('vistas/coacher/logicas/pedidos.php');
		...
		switch ($url[0]) 
		{
			...
			case 'coacher':
				if(isset($url[1]))
				{
					...
					{
						case '':
							require_once('vistas/admin/logicas/lista_coachers.php');
						break;
							...
							if(isset($url[2]))
							{
								switch ($url[2]) 
								{
									...
									case ''.$url[2].'':
										...
										if($resultado == '')
										{
											header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/coacher/pedidos_libres/');
										}
										else
										{
							...
							if(isset($url[2]))
							{
								switch ($url[2]) 
								{
									...
									case ''.$url[2].'':
										...
										if($resultado == '')
										{
											header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/coacher/pedidos_desocupados/');
										}
										else
										{
											require_once('vistas/admin/logicas/pedidos.php');
							...
							if(isset($url[2]))
							{
								switch ($url[2]) 
								{
									...
									case ''.$url[2].'':
										...
										if($resultado == '')
										{
											header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/coacher/pedidos_activos/');
										}
										else
										{
											require_once('vistas/admin/logicas/pedidos.php');
							...
							if(isset($url[2]))
							{
								switch ($url[2]) 
								{
									...
									case ''.$url[2].'':
										...
										if($resultado == '')
										{
											header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/coacher/pedidos_cancelados/');
										}
										else
										{
											require_once('vistas/admin/logicas/pedidos.php');
							...
							if(isset($url[2]))
							{
								switch ($url[2]) 
								{
									...
									case ''.$url[2].'':
										...
										if($resultado == '')
										{
											header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/coacher/pedidos_terminados/');
										}
										else
										{
											require_once('vistas/admin/logicas/pedidos.php');
