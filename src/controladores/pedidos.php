...
if (isset($_SESSION['usuario'])) 
{
		...
		switch ($url[0]) 
		{
			case 'coaching':
				if(isset($url[1]))
				{
					...
					{
						case '':
							require_once('vistas/user/logicas/coaching.php');
						break;
						...
						case 'mis_ordenes':
							if(isset($url[2]))
							{
								...
								{
									case '':
										require_once('vistas/user/logicas/mis_ordenes_coaching.php');
									break;
									...
									case ''.$url[2].'':
										...
										{
											require_once('vistas/user/logicas/orden_coaching.php');	
										}
									break;	
								}
							}
	...
	elseif($_SESSION['tipo'] == 'coacher')
	{
		if(isset($url[1]))
		{
			...
			{
				case '':
					require_once('vistas/coacher/logicas/lista_pedidos_libres.php');
				break;
				...
				case ''.$url[1].'':
					...
					if($resultado == '')
					{
						header('Location: http://'.$_SERVER['HTTP_HOST'].'/miembros/pedidos');
					}
					else
					{
						require_once('vistas/coacher/logicas/ver_pedido.php');
					}
				break;
			}
		}
...
else
{
	...
	{
		case 'coaching':
			require_once('vistas/desconectado/logicas/coaching.php');
		break;
	}
}
?>